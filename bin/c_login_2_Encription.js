...
function setTimeout(callback,timeouot){
	callback();
}
...
$.RSA = $pt.RSA = function() {
    ...
    function W(t, e) {
        var i;
        return i = 256 > t || e.isEven() ? new A(e) : new U(e),
        this.exp(t, i)
    }
    function X(t) {
        ht[ft++] ^= 255 & t,
    ...
    st && "Microsoft Internet Explorer" == navigator.appName ? (r.prototype.am = l,
    pt = 30) : st && "Netscape" != navigator.appName ? (r.prototype.am = a,
    ...
    if (null == ht) {
        ...
        if ("Netscape" == navigator.appName && navigator.appVersion < "5" && window.crypto && window.crypto.random) {
            ...
            for (_t = 0; _t < mt.length; ++_t)
                ht[ft++] = 255 & mt.charCodeAt(_t)
        }
        for (; $t > ft; )
            _t = Math.floor(65536 * Math.random()),
            ht[ft++] = _t >>> 8,
            ht[ft++] = 255 & _t;
        ft = 0,
        Z()
...
$.tmpTEA = function(t) {
    ...
    function u(t) {
        for (var e = 16, o = i(t, 0, 4), p = i(t, 4, 4), r = i(f, 0, 4), s = i(f, 4, 4), a = i(f, 8, 4), l = i(f, 12, 4), c = 0, u = 2654435769; e-- > 0; )
            c += u,
            c = (4294967295 & c) >>> 0,
            o += (p << 4) + r ^ p + c ^ (p >>> 5) + s,
            o = (4294967295 & o) >>> 0,
    ...
    function g(t) {
        for (var e = 16, o = i(t, 0, 4), p = i(t, 4, 4), r = i(f, 0, 4), s = i(f, 4, 4), a = i(f, 8, 4), l = i(f, 12, 4), c = 3816266640, u = 2654435769; e-- > 0; )
            p -= (o << 4) + a ^ o + c ^ (o >>> 5) + l,
            p = (4294967295 & p) >>> 0,
            o -= (p << 4) + r ^ p + c ^ (p >>> 5) + s,
            o = (4294967295 & o) >>> 0,
...
$.Encryption = $pt.Encryption = function() {
    ...
    function h(e, i, n, o) {
        ...
        window.btoa(g(h)).replace(/[\/\+=]/g, function(t) {
            return {
                "/": "-",
                "+": "*",
                "=": "_"
...
var cfg_vcode = "";
var cfg_session = "";
function ptui_checkVC(type_maby,vcode,qq,session,version_maby){
	cfg_qq = qq;
	cfg_vcode = vcode;
	cfg_session = session;
}
...
function iGetSession(){
	return cfg_session;
}
"ptuiCB('0','0','http://ptlogin2.game.qq.com/check_sig?pttype=1&uin=792272773&service=login&nodirect=0&ptsigx=de9f01461d3b5ebb9fe9796d6e692ef6df4f397d40e685f8a9b375034533e419a017701caf87295c5b9dcf2781b1e29eb31f8f94d24a073e63fafb5db627a8e8&s_url=http%3A%2F%2Fwww.daoju.qq.com%2Fmall%2F&f_url=&ptlang=2052&ptredirect=101&aid=21000501&daid=8&j_later=0&low_login_hour=0&regmaster=0&pt_login_type=1&pt_aid=0&pt_aaid=0&pt_light=0&pt_3rd_aid=0','1','登录成功！', 'Yui');\r\n"

var cfg_login_one = {};

function ptuiCB(_v1,_v2,_url,_v4,_msg,_name)
{
	cfg_login_one.v1 = _v1;
	cfg_login_one.v2 = _v2;
	cfg_login_one.url = _url;
	cfg_login_one.msg = _msg;
	cfg_login_one.name = _name;
}